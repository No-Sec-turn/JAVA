...
public class Ex4 {
	public static void main(String[] args) {
		 ...
		 *    생성자 정의 시 접근제한자를 private 으로 선언
		 * 2. 자신의 클래스 내에서 직접 객체를 생성하여 참조변수에 저장
		 *    => 참조변수의 접근제한자를 private 으로 선언하여 접근 제한
		 *    => 참조변수를 static 변수로 선언하여 객체 생성 없이 로딩
		 * 3. 생성된 인스턴스를 외부로 리턴하는 Getter 를 정의
...
class SingletonClass{
    ...
    //  ==> 또한, 외부에서 변수에 접근하여 함부로 값을 변경하지 못하도록 접근 제한자를 private으로 선언
