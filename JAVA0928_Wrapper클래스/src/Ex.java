...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *   Wrapper 클래스가 제공하는 메서드, 상수 등의 활용 가능하므로
		...
		System.out.println("10,20 중 최댓값 : " + Integer.max(10,20) );
